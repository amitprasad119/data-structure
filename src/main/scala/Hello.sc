...
"amitprasad".groupBy(identity).map { case (c, freq) => c -> freq.size }

case class Student(name: String, age: Int)

val students = List(Student("Amit", 29), Student("Sumit", 20), Student("Gannu", 5))
val studentMap = Map(1 -> "Amit", 2 -> "Sumit", 3 -> "Pankaj")
implicit val orderByAge: Ordering[Student] = Ordering.fromLessThan(_.age < _.age)
